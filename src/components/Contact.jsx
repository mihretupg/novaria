...
const CARDS = [
  { icon: MessageCircle, title: 'WhatsApp', value: 'Chat Now',       sub: 'Fastest response',   action: () => window.open(`https://wa.me/${WHATSAPP_NUMBER}`, '_blank'), highlight: true },
  { icon: Phone,         title: 'Phone',    value: '+1 (470) 419-0528', sub: 'Call anytime',     action: () => window.open('tel:+14704190528'),                           highlight: false },
...
export default function Contact() {
  ...
  return (
    <section id="contact" ref={sectionRef} className="relative py-32 overflow-hidden section-bg">
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className={`text-center mb-20 transition-all duration-700 ${inView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
          ...
          <p className="text-theme-muted max-w-xl mx-auto leading-relaxed">
            Reach us through WhatsApp for the fastest response. Our team is available 24/7 to assist with bookings, modifications, and questions.
          </p>
